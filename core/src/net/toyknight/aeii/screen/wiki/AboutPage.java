...
public class AboutPage extends AEIITable {
    ...
    public AboutPage(Wiki wiki) {
        ...
        Label label_about_p2 = new Label(Language.getText("WIKI_ABOUT_P2"), getWiki().getContext().getSkin());
        ...
        Label label_program = new Label("[" + Language.getText("LB_PROGRAM") + "]", getWiki().getContext().getSkin());
        ...
        Label label_balancing = new Label("[" + Language.getText("LB_BALANCING") + "]", getWiki().getContext().getSkin());
        ...
        Label label_translation = new Label("[" + Language.getText("LB_TRANSLATION") + "]", getWiki().getContext().getSkin());
