...
public class AttackInformationRenderer {
    ...
    private void drawInformation(Batch batch, Unit attacker, Unit defender) {
        ...
        float lbh = AER.resources.getTextFont().getCapHeight(); //label height
        int tfh = AER.font.getSCharHeight() + ts / 12; //text field height
        ...
        //draw background
        batch.draw(AER.resources.getBorderDarkColor(), 0, infoy - ts / 24, screen.getViewportWidth(), infoh);
        batch.draw(AER.resources.getBorderLightColor(), 0, infoy, screen.getViewportWidth(), infoh);

        //draw icons
        batch.draw(AER.resources.getBattleHudIcon(0), lmargin, infoy + (infoh - hh) / 2, hw, hh);
        batch.draw(AER.resources.getBattleHudIcon(1), lmargin + hw + tfw + ts * 2 / 24, infoy + (infoh - hh) / 2, hw, hh);
        batch.draw(AER.resources.getBattleHudIcon(2), lmargin + hw * 2 + tfw * 2 + ts * 4 / 24, infoy + (infoh - hh) / 2, hw, hh);
        batch.draw(AER.resources.getBattleHudIcon(3), lmargin + hw * 3 + tfw * 3 + ts * 6 / 24, infoy + (infoh - hh) / 2, hw, hh);

        //draw text field
        batch.draw(AER.resources.getPanelBackground(), lmargin + hw + ts / 24, infoy + ts / 24, tfw, tfh);
        batch.draw(AER.resources.getPanelBackground(), lmargin + hw + ts / 24, infoy + tfh + ts * 2 / 24, tfw, tfh);
        batch.draw(AER.resources.getPanelBackground(), lmargin + hw * 2 + tfw + ts * 3 / 24, infoy + ts / 24, tfw, tfh);
        batch.draw(AER.resources.getPanelBackground(), lmargin + hw * 2 + tfw + ts * 3 / 24, infoy + tfh + ts * 2 / 24, tfw, tfh);
        batch.draw(AER.resources.getPanelBackground(), lmargin + hw * 3 + tfw * 2 + ts * 5 / 24, infoy + ts / 24, tfw, tfh);
        batch.draw(AER.resources.getPanelBackground(), lmargin + hw * 3 + tfw * 2 + ts * 5 / 24, infoy + tfh + ts * 2 / 24, tfw, tfh);
        batch.draw(AER.resources.getPanelBackground(), lmargin + hw * 4 + tfw * 3 + ts * 7 / 24, infoy + ts / 24, tfw, tfh);
        batch.draw(AER.resources.getPanelBackground(), lmargin + hw * 4 + tfw * 3 + ts * 7 / 24, infoy + tfh + ts * 2 / 24, tfw, tfh);

        batch.draw(AER.resources.getTeamBackground(attacker.getTeam()), lmargin + hw + ts * 2 / 24, infoy + ts * 2 / 24, ts / 4, AER.font.getSCharHeight());
        batch.draw(AER.resources.getTeamBackground(attacker.getTeam()), lmargin + hw * 2 + tfw + ts * 4 / 24, infoy + ts * 2 / 24, ts / 4, AER.font.getSCharHeight());
        batch.draw(AER.resources.getTeamBackground(attacker.getTeam()), lmargin + hw * 3 + tfw * 2 + ts * 6 / 24, infoy + ts * 2 / 24, ts / 4, AER.font.getSCharHeight());
        batch.draw(AER.resources.getTeamBackground(attacker.getTeam()), lmargin + hw * 4 + tfw * 3 + ts * 8 / 24, infoy + ts * 2 / 24, ts / 4, AER.font.getSCharHeight());

        batch.draw(AER.resources.getTeamBackground(defender.getTeam()), lmargin + hw + ts * 2 / 24, infoy + tfh + ts * 3 / 24, ts / 4, AER.font.getSCharHeight());
        batch.draw(AER.resources.getTeamBackground(defender.getTeam()), lmargin + hw * 2 + tfw + ts * 4 / 24, infoy + tfh + ts * 3 / 24, ts / 4, AER.font.getSCharHeight());
        batch.draw(AER.resources.getTeamBackground(defender.getTeam()), lmargin + hw * 3 + tfw * 2 + ts * 6 / 24, infoy + tfh + ts * 3 / 24, ts / 4, AER.font.getSCharHeight());
        batch.draw(AER.resources.getTeamBackground(defender.getTeam()), lmargin + hw * 4 + tfw * 3 + ts * 8 / 24, infoy + tfh + ts * 3 / 24, ts / 4, AER.font.getSCharHeight());
        ...
        AER.font.drawText(batch, attacker_attack_str,
                lmargin + hw + ts * 3 / 24 + ts / 4,
                infoy + ts / 24 + (tfh - lbh) / 2 + lbh);
        if (attacker_atk_bonus > 0) {
            float attack_width = AER.font.getTextLayout(attacker_attack_str).width;
            batch.draw(AER.resources.getArrowIcon(1),
        ...
        if (attacker_atk_bonus < 0) {
            float attack_width = AER.font.getTextLayout(attacker_attack_str).width;
            batch.draw(AER.resources.getArrowIcon(2),
                    lmargin + hw + ts * 4 / 24 + ts / 4 + attack_width,
                    infoy + ts / 24 + (tfh - ah) / 2,
                    aw, ah);
        }
        ...
        AER.font.drawText(batch, defender_attack_str,
                lmargin + hw + ts * 3 / 24 + ts / 4,
                infoy + tfh + ts * 2 / 24 + (tfh - lbh) / 2 + lbh);
        if (modified_defender_atk > 0 && defender_atk_bonus > 0) {
            float attack_width = AER.font.getTextLayout(defender_attack_str).width;
            batch.draw(AER.resources.getArrowIcon(1),
                    lmargin + hw + ts * 4 / 24 + ts / 4 + attack_width,
        ...
        AER.font.drawText(batch, attacker_p_defence_str,
        ...
        AER.font.drawText(batch, attacker_m_defence_str,
                lmargin + hw * 3 + tfw * 2 + 7 * ts / 24 + ts / 4,
                infoy + ts / 24 + (tfh - lbh) / 2 + lbh);

        if (attacker_p_defence_bonus > 0) {
            float p_defence_width = AER.font.getTextLayout(attacker_p_defence_str).width;
            batch.draw(AER.resources.getArrowIcon(1),
        ...
        if (attacker_m_defence_bonus > 0) {
            float m_defence_width = AER.font.getTextLayout(attacker_m_defence_str).width;
            batch.draw(AER.resources.getArrowIcon(1),
        ...
        AER.font.drawText(batch, defender_p_defence_str,
        ...
        AER.font.drawText(batch, defender_m_defence_str,
                lmargin + hw * 3 + tfw * 2 + 7 * ts / 24 + ts / 4,
                infoy + tfh + 2 * ts / 24 + (tfh - lbh) / 2 + lbh);
        if (defender_p_defence_bonus > 0) {
            float p_defence_width = AER.font.getTextLayout(defender_p_defence_str).width;
            batch.draw(AER.resources.getArrowIcon(1),
                    lmargin + hw * 2 + tfw + 6 * ts / 24 + ts / 4 + p_defence_width,
        ...
        if (defender_m_defence_bonus > 0) {
            float m_defence_width = AER.font.getTextLayout(defender_m_defence_str).width;
            batch.draw(AER.resources.getArrowIcon(1),
                    lmargin + hw * 3 + tfw * 2 + 8 * ts / 24 + ts / 4 + m_defence_width,
                    infoy + tfh + 2 * ts / 24 + (tfh - ah) / 2,
                    aw, ah);
        ...
        AER.font.drawText(batch, Integer.toString(attacker_level),
                lmargin + hw * 4 + tfw * 3 + 9 * ts / 24 + ts / 4,
                infoy + ts / 24 + (tfh - lbh) / 2 + lbh);
        int defender_level = defender.getLevel();
        AER.font.drawText(batch, Integer.toString(defender_level),
                lmargin + hw * 4 + tfw * 3 + 9 * ts / 24 + ts / 4,
                infoy + tfh + 2 * ts / 24 + (tfh - lbh) / 2 + lbh);
        batch.flush();
    }
