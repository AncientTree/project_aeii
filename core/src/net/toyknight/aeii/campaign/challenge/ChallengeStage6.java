...
public class ChallengeStage6 extends StageController {
    ...
    public void onGameStart() {
        ...
        Message message1 = new Message(5, Language.getText("CAMPAIGN_CHALLENGE_STAGE_6_MESSAGE_2"));
        getContext().message(message1);
        getContext().focus(13, 13);
        Message message2 = new Message(5, Language.getText("CAMPAIGN_CHALLENGE_STAGE_6_MESSAGE_3"));
    ...
    public String[] getObjectives() {
        return new String[]{
                Language.getText("CAMPAIGN_CHALLENGE_STAGE_6_OBJECTIVE_1"),
                Language.getText("CAMPAIGN_CHALLENGE_STAGE_6_OBJECTIVE_2"),
        };
    }
