 ...
 */
public class AEIIIStage2 extends StageController {
    ...
    public void onUnitStandby(Unit unit) {
        if(unit.getTeam() == getPlayerTeam() && unit.getY() <= 4)
        {
    ...
    public void onTurnStart(int turn) {
        if(getContext().get("Village") == 0 && turn % 2 == 0)
        {
            getContext().get_unit(3, 5).setStandby(true);
            getContext().get_unit(3, 4).setStandby(true);
        }
        if(turn == 2 || turn == 4)
        {
    ...
    private void reinforce()
    {
        ...
        Message message7 = new Message(3, AER.lang.getText("CAMPAIGN_AEIII_STAGE_2_MESSAGE_7"));
