...
public class AEIIStage3 extends StageController {
    ...
    public void onGameStart() {
        ...
        Message message1 = new Message(5, AER.lang.getText("CAMPAIGN_AEII_STAGE_3_MESSAGE_1"));
        Message message2 = new Message(0, AER.lang.getText("CAMPAIGN_AEII_STAGE_3_MESSAGE_2"));
        Message message3 = new Message(5, AER.lang.getText("CAMPAIGN_AEII_STAGE_3_MESSAGE_3"));
    ...
    public void onUnitStandby(Unit unit) {
        if (unit.getTeam() == getPlayerTeam() && getContext().get("reinforced") == 0 && unit.getY() <= 10) {
            ...
            Message message4 = new Message(5, AER.lang.getText("CAMPAIGN_AEII_STAGE_3_MESSAGE_4"));
            getContext().message(message4);
            getContext().reinforce(1,
                    new Reinforcement(2, 3, 8),
                    new Reinforcement(4, 4, 7),
                    new Reinforcement(2, 5, 8));
            Message message5 = new Message(5, AER.lang.getText("CAMPAIGN_AEII_STAGE_3_MESSAGE_5"));
            Message message6 = new Message(-1, AER.lang.getText("CAMPAIGN_AEII_STAGE_3_MESSAGE_6"));
            Message message7 = new Message(0, AER.lang.getText("CAMPAIGN_AEII_STAGE_3_MESSAGE_7"));
            getContext().message(message5, message6, message7);
            getContext().team(3, 8, 0);
            getContext().team(4, 7, 0);
            getContext().team(5, 8, 0);
        }
        if(unit.getTeam() == getPlayerTeam() && getContext().get("reinforced") == 1 && unit.getY() <= 5)
        {
            getContext().reinforce(1,
                    new Reinforcement(5, 1, 2),
                    new Reinforcement(4, 2, 1),
                    new Reinforcement(5, 3, 2));
            getContext().set("reinforced", 2);
        }
        if (isCommander(unit, getPlayerTeam()) && getContext().get("reinforced") == 2 && unit.getX() == 2 && unit.getY() <= 1) {
            getContext().clear();
        }
    ...
    public String[] getObjectives() {
        return new String[]{AER.lang.getText("CAMPAIGN_AEII_STAGE_3_OBJECTIVE")};
    }
    ...
    public String getStageName() {
        return AER.lang.getText("CAMPAIGN_AEII_STAGE_3_NAME");
    }
